<%-- 
    Document   : dashboard-organizacion
    Created on : 20 nov 2025, 21:25:15
    Author     : flori
--%>
...
<%
    ...
    if (usuario == null || !"Organizacion".equals(usuario.getRol())) {
...
<head>
    ...
    <title>Dashboard Organización - SGVC</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <% if ("Pendiente".equals(estado)) { %>
            <div class="alert alert-warning">
                ⏳ <strong>Solicitud Pendiente:</strong> Tu organización está en proceso de validación. 
                Podrás publicar proyectos una vez que un administrador apruebe tu solicitud.
            </div>
        <% } else if ("Activo".equals(estado)) { %>
            <div class="alert alert-success">
                ✓ <strong>Organización Aprobada:</strong> Tu organización ha sido validada. 
                ¡Ya puedes publicar proyectos!
            </div>
        <% } %>
        
        <div class="welcome">
            <h1>¡Bienvenido, <%= username %>! 🏢</h1>
            <p>Gestiona tus proyectos y voluntarios desde aquí</p>
        </div>
        ...
        <div class="actions <%= "Pendiente".equals(estado) ? "disabled-overlay" : "" %>">
            ...
            <div class="action-card" onclick="<%= "Pendiente".equals(estado) ? "" : "location.href='#'" %>">
                <div class="icon">📝</div>
                <h3>Mis Proyectos</h3>
                <p>Gestiona tus proyectos publicados</p>
            ...
            <div class="action-card" onclick="<%= "Pendiente".equals(estado) ? "" : "location.href='#'" %>">
                ...
                <p>Revisa y acepta postulaciones</p>
            ...
            <div class="action-card" onclick="<%= "Pendiente".equals(estado) ? "" : "location.href='#'" %>">
                ...
                <p>Confirma la asistencia de voluntarios</p>
                <a href="#" class="btn">Validar</a>
            </div>
            
            <div class="action-card" onclick="location.href='OrganizacionControl?accion=miPerfil'">
                <div class="icon">🏢</div>
                <h3>Mi Organización</h3>
                <p>Actualiza la información institucional</p>
                <a href="OrganizacionControl?accion=miPerfil" class="btn">Ver Perfil</a>
            </div>
            
            <div class="action-card" onclick="<%= "Pendiente".equals(estado) ? "" : "location.href='#'" %>">
                <div class="icon">📊</div>
                <h3>Reportes</h3>
                <p>Genera reportes de asistencia e impacto</p>
